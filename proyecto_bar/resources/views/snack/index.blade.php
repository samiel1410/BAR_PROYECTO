                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('snacks.destroy',$snack->id) }}" method="POST">
                                            @can('snacks.show')
                                            <a class="btn btn-sm btn-primary " href="{{ route('snacks.show',$snack->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                            @endcan
                                            @can('snacks.edit')
                                            <a class="btn btn-sm btn-success" href="{{ route('snacks.edit',$snack->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                            @csrf
                                            @method('DELETE')
