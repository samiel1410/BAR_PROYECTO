                ...
                @endforeach</td>
                                            ...
                                            <td>
                                                <form action="{{ route('buzons.destroy',$buzon->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('buzons.show',$buzon->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('buzons.edit',$buzon->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
